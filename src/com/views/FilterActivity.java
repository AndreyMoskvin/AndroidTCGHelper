...
public class FilterActivity extends Activity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeSpinner.setTag(CardsDBOperator.KEY_TYPE);
        ...
        costSpinner.setTag(CardsDBOperator.KEY_COST);
        ...
        setSpinner.setTag(CardsDBOperator.KEY_SET);
        ...
        raritySpinner.setTag(CardsDBOperator.KEY_RARITY);
